function PasswordChecker(wrapperId, passwordInputFieldId, passwordSubmitButtonId) {
    ...
    this.wrapperField = $(wrapperId);                       // In diesen drei Zeilen (11,12,13) wurde was geändert
    ...
    this.passwordField.blur(function() {        //hier wurde was geändert
    ...
    this.passwordField.keydown(function() {     // hier wurde was geändert
        that.check();
    });

    this.passwordField.focus(function() {   // hier wurde was geändert
        that.check();
    });

    this.passwordSubmitButton.click(function() {    // hier wurde was geändert
        that.check();
    });
    ...
    this.check = function() {
        ...
        if(this.wrapperField && this.passwordField && this.passwordSubmitButton) {
            ...
            if(longEnough && hasSpecialChars) {
                this.wrapperField.removeClass(this.warningClass + ' ' + this.errorClass).addClass(this.successClass);       //in den Zeilen 54 bis 62 wurde was geändert
